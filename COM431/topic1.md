...
We ourselves do _not_ need to do this calculation. The _computer_ does it. But we can see, because it's simple arithmetic, the computer is able to do it very quickly. So, **arrays are optimised for fast look-up of data using a numerical index**.
